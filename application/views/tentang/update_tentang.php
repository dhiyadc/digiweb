            ...
            <div class="form-panel">
              ...
              <form enctype="multipart/form-data" action="<?= base_url(); ?>tentang/updateTentang/<?= $staff['id']; ?>" class="cmxform form-horizontal style-form" id="commentForm" method="post">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input type="text" maxlength="150" size="40" name="nama" id="nama" class="form-control" value="<?= $staff['nama'] ?>">
                        <?= form_error('nama') ?>
                    </div>
                  </div>
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input type="text" maxlength="150" size="40" name="jabatan" id="jabatan" class="form-control" value="<?= $staff['jabatan'] ?>">
                        <?= form_error('jabatan') ?>
                    </div>
                  </div>
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input type="text" maxlength="150" size="40" name="quote" id="quote" class="form-control" value="<?= $staff['quote'] ?>">
                        <?= form_error('quote') ?>
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10 col-sm-9">
                        <input type="radio" style="width: 20px" class="radio form-control" name="prioritas" value="1" <?= ($staff['prioritas'] == "1") ? "checked" : '' ?>>Iya
                        <input type="radio" style="width: 20px" class="radio form-control" name="prioritas" value="0" <?= ($staff['prioritas'] == "0") ? "checked" : '' ?>>Tidak
                    </div>
                  </div>
                  <div class="form-group">
