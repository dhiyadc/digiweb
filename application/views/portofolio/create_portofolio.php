          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <div class=" form">
                ...
                <!-- <form class="cmxform form-horizontal style-form" id="commentForm" method="get" action=""> -->
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                        <input type="url" class="form-control" name="link" id="link" value="<?= set_value('link');?>" placeholder="https://">
                    </div>
                  </div>
                  <div class="form-group ">
              ...
              <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                  <input type="submit" name="submit" value="Save" class="btn btn-theme">
                  <a href="<?= base_url() ?>portofolio"><button class="btn btn-theme04" type="button">Cancel</button>
                </div>
              </div>
            </form>
          </div>
